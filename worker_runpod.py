...
def generate(input):
    ...
    clip_vision_conditioning1 = CLIPVisionEncode.encode(clip_vision, image1, crop=True)[0]
    ...
    clip_vision_conditioning2 = CLIPVisionEncode.encode(clip_vision, image2, crop=True)[0]
